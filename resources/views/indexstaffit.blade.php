  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary3 text-white text-center">
      <div class="container">
        ...
        <h2 class="font-weight-light mb-0">Ketua Komunitas</h2>
      </div>
    </header>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        ...
        <div class="row">
          ...
          </div><div class="col-md-6 col-lg-3" style="justify-content: center; font-family: Palatino Linotype; font-size: 18px; margin-left: -20px; margin-top: 25px;"> Laporan</div> 
          </a>
    </section>
