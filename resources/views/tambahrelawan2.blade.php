...
@foreach($data2 as $datas)
        ...
        <form action="{{ route('relawan.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_relawan" name="nama" value="{{$datas->nama_ketua}}" readonly="true">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="nama" name="email" value="{{$datas->email_ketua}}" readonly="true">
                </div>
                   <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nohp" name="hp" value="{{ $datas->hp_ketua }}" readonly="true">
                </div>
                <div class="form-group">
                    <label for="nohp">Skala kecakapan relawan:</label>
                <input type="number" class="form-control" name="skala_kec" min="1" max="100">
              </div>
                <div class="form-group">
                   <label for="jenisbencana">ID Komunitas:</label>
                   <input type="text" class="form-control" id="nohp" name="id_kom" value="{{ $datas->id_kom }}" readonly="true">
                </div>
                <div class="form-group">
