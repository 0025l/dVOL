...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{ route('fuzzy') }}">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Aturan FUZZY</h2>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table align="center" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  @foreach($aturan as $key => $datas)
                    <tr>
                         <td>{{ $datas->jika }}</td>
                        <td>{{ $datas->skala_kec }}</td>
                        <td>{{ $datas->variabel1 }}</td>
                        <td>{{ $datas->operator }}</td>
                        <td>{{ $datas->umur }}</td>
                        <td>{{ $datas->variabel2 }}</td>
                        <td>{{ $datas->maka }}</td>
                        <td>{{ $datas->skala_ben }}</td>
                        <td>{{ $datas->hasil }}</td>
