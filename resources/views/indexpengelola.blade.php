...
?>
  ...
  <body id="page-top">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ route('bencana.edit2', $datas->id_benc) }}">
                  ...
                  <div>
                    ...
                    <span class="font-weight-thin">{{ $datas->nama_bencana }}</span>
                  </div>
                </a>
                @endif
                @endforeach
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ route('kegiatan.edit', $datas->id_keg) }}">
                  ...
                  <div>
                    <div class="small text-gray-500">{{ $datas->created_at }}</div>
                    <span class="font-weight-thin">{{ $datas->nama_keg }}</span>
                  </div>
                </a>
                @endif
                @endforeach
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" style="margin-top: 3px;" src="/assets/user.png">
              </a>
    ...
    <header class="masthead bg-primary3 text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" src="/assets/businessman.png" alt="">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-2">
          <a class="portfolio-item d-block mx-auto" href="{{ route('chart2') }}">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
              <img class="img-fluid" src="/assets/chart.png" alt="">
